...
namespace Level.Manager
{
    ...
    {
        #region Singletone
        private static LevelManagerView _default;
        public static LevelManagerView Default { get => _default; }
        public LevelManagerView() => _default = this;
        #endregion
        ...
        [SerializeField] LevelsListView levels;
        public List<LevelView> Levels => levels.lvls;
        ...
        private void SelLevelParams(LevelView levelView)
        {
            if (levelView)
            {
                ClearChilds();
            ...
            {
                Instantiate(levelView, transform);
            }
            else
            {
                PrefabUtility.InstantiatePrefab(levelView, transform);
            }
#else
